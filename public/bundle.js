...
var app = (function () {
	...
	*/
	...
	function create_each_block(ctx) {
		...
		return {
			c: function create() {
				...
				t = space();
				div.className = "row svelte-iff3l2";
				add_location(div, file$1, 38, 4, 628);
			},
	...
	function create_fragment$1(ctx) {
		var main, p, t0, t1, t2, t3, t4, main_transition, current;
		...
		return {
			c: function create() {
				...
				p.className = "info svelte-iff3l2";
				add_location(p, file$1, 34, 2, 529);
				main.className = "board svelte-iff3l2";
				add_location(main, file$1, 33, 0, 490);
			},
	...
	function instance$1($$self, $$props, $$invalidate) {
	  ...
	  let scaleArr = [];
		...
		$$self.$set = $$props => {
			...
			if ('moves' in $$props) $$invalidate('moves', moves = $$props.moves);
		};
	...
	class Board extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$1, create_fragment$1, safe_not_equal, ["scale", "moves"]);
			...
			if (ctx.moves === undefined && !('moves' in props)) {
				console.warn("<Board> was created without expected prop 'moves'");
			}
		}
	...
	/* src/components/Result.svelte generated by Svelte v3.4.2 */

	const file$4 = "src/components/Result.svelte";
	...
	function create_else_block(ctx) {
		...
		return {
			c: function create() {
				p = element("p");
				p.textContent = "Ничья";
				add_location(p, file$4, 23, 4, 447);
			},
	...
	function create_if_block(ctx) {
		...
		return {
			c: function create() {
				...
				t1 = text(ctx.player);
				t2 = text(" победил");
				add_location(p, file$4, 21, 4, 399);
			},
	...
	function create_fragment$4(ctx) {
		...
		function select_block_type(ctx) {
			if (ctx.gameStatus == 'win') return create_if_block;
		...
		return {
			c: function create() {
				...
				button.className = "btn";
				add_location(button, file$4, 25, 2, 470);
				div.className = "results svelte-1tl4zfn";
				add_location(div, file$4, 19, 0, 344);
	...
	function instance$4($$self, $$props, $$invalidate) {
	  ...
	  function restart() {
		...
		$$self.$set = $$props => {
			if ('gameStatus' in $$props) $$invalidate('gameStatus', gameStatus = $$props.gameStatus);
			if ('player' in $$props) $$invalidate('player', player = $$props.player);
		};

		return { gameStatus, player, restart };
	}

	class Result extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$4, create_fragment$4, safe_not_equal, ["gameStatus", "player"]);

			const { ctx } = this.$$;
			const props = options.props || {};
			if (ctx.gameStatus === undefined && !('gameStatus' in props)) {
				console.warn("<Result> was created without expected prop 'gameStatus'");
			}
			if (ctx.player === undefined && !('player' in props)) {
				console.warn("<Result> was created without expected prop 'player'");
			}
		}
	...
	function create_else_block$1(ctx) {
		...
		var result = new Result({
			...
			player: ctx.notActivePlayer
		},
			$$inline: true
		});
		result.$on("restart", ctx.restart);
		...
		return {
			...
			p: function update(changed, ctx) {
				var result_changes = {};
				if (changed.gameStatus) result_changes.gameStatus = ctx.gameStatus;
				if (changed.notActivePlayer) result_changes.player = ctx.notActivePlayer;
	...
	function create_if_block_1(ctx) {
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if (changed.moves) board_1_changes.moves = ctx.moves;
	...
	function create_fragment$5(ctx) {
		...
		return {
			c: function create() {
				...
				if_block.c();
				div.id = "app";
				div.className = "svelte-1oyob1g";
				add_location(div, file$5, 124, 0, 2549);
			},
